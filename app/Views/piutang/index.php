...
$(document).ready(function() {
    ...
    // let array = []
    id.forEach((i, index) => {
        $.getJSON("http://localhost/simaung/public/piutang/orang-utang/" + i.value, function(data) {
            taruhSini[index].innerHTML = (parseInt(data.piutang.nominal)).toLocaleString(
                'id-ID')
            cicilDisini[index].innerHTML = ('0').toLocaleString('id-ID')
        });

        $.getJSON("http://localhost/simaung/public/piutang/cicilan/" + i.value, function(data) {
