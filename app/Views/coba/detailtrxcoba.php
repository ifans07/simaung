            ...
            <div>
                <div class="row row-cols-1 row-cols-md-3 g-2">
                    <?php foreach ($d as $data) : ?>
                        ...
                        ?>
                        <a href="<?= base_url('coba/detaillog'.$data['tanggal']) ?>" class="col box-cost">
                            <div class="card dompet" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $data['catatan'] ?>">
                                <div class=" row g-2">
                                    <div class="col-3">
                                        <div class="icon-number">
                                            <?php
